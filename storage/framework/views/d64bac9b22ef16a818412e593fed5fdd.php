...
<?php endif; ?>
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                 <a href="<?php echo e(route('add_jobs')); ?>"> Post a job!</a> 
                </div>
                <?php endif; ?>

                <?php if(Auth::user()->role == 2): ?>
                <div class="p-6 text-gray-900 dark:text-gray-100">
                 <a href="<?php echo e(route('jobs')); ?>"> Job List!</a> 
                </div>
                <?php endif; ?>
                ...
                <?php endif; ?>
                   <!-- <?php if (isset($component)) { $__componentOriginalc295f12dca9d42f28a259237a5724830 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc295f12dca9d42f28a259237a5724830 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.nav-link','data' => ['href' => route('jobs'),'active' => request()->routeIs('jobs')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('nav-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('jobs')),'active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->routeIs('jobs'))]); ?>
...
<?php /**PATH C:\xampp\htdocs\job_portal_system\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>